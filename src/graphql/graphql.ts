...
export type Notification = SubscriberNotification | SystemNotification;
...
export type ResolversTypes = {
  ...
  Notification:
    | ResolversTypes["SubscriberNotification"]
...
export type ResolversParentTypes = {
  ...
  NewsTag: NewsTag;
  Notification:
    | ResolversParentTypes["SubscriberNotification"]
...
export type CaseItemResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["CaseItem"] = ResolversParentTypes["CaseItem"]
> = {
...
export type GlobalChatMessageResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["GlobalChatMessage"] = ResolversParentTypes["GlobalChatMessage"]
> = {
  createdAt?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
...
export type GlobalChatRemoveResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["GlobalChatRemove"] = ResolversParentTypes["GlobalChatRemove"]
> = {
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  server?: Resolver<ResolversTypes["ObjectID"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type IconSearchResultResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["IconSearchResult"] = ResolversParentTypes["IconSearchResult"]
> = {
...
export interface MediaLinkScalarConfig
  extends GraphQLScalarTypeConfig<ResolversTypes["MediaLink"], any> {
  name: "MediaLink";
}
...
export type MessageSearchResultResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["MessageSearchResult"] = ResolversParentTypes["MessageSearchResult"]
> = {
  hasMore?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
...
> = {
  addToBlacklist?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationAddToBlacklistArgs, "id">
  >;
  addView?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationAddViewArgs, "profile">
  >;
  buy?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationBuyArgs, "itemType" | "server">
  >;
  buyTref?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationBuyTrefArgs, "amount">
  >;
  ...
  >;
  createGlobalChatMessage?: Resolver<
    ResolversTypes["GlobalChatMessage"],
    ParentType,
    ContextType,
    RequireFields<MutationCreateGlobalChatMessageArgs, "input">
  >;
  createIcon?: Resolver<
    ResolversTypes["Icon"],
    ParentType,
    ContextType,
    RequireFields<MutationCreateIconArgs, "input">
  >;
  ...
  createReport?: Resolver<
    ResolversTypes["ReportChat"],
    ParentType,
    ContextType,
    RequireFields<MutationCreateReportArgs, "input">
  >;
  ...
  >;
  editCategory?: Resolver<
    ResolversTypes["Category"],
    ParentType,
    ContextType,
    RequireFields<MutationEditCategoryArgs, "id" | "input">
  >;
  editChat?: Resolver<
    ResolversTypes["Chat"],
    ParentType,
    ContextType,
    RequireFields<MutationEditChatArgs, "id" | "input">
  >;
  editIcon?: Resolver<
    ResolversTypes["Icon"],
    ParentType,
    ContextType,
    RequireFields<MutationEditIconArgs, "id" | "input">
  >;
  editMessage?: Resolver<
    ResolversTypes["Message"],
    ParentType,
    ContextType,
    RequireFields<MutationEditMessageArgs, "id" | "input">
  >;
  editProduct?: Resolver<
    ResolversTypes["Product"],
    ParentType,
    ContextType,
    RequireFields<MutationEditProductArgs, "id" | "input">
  >;
  editProfile?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationEditProfileArgs, "id" | "input">
  >;
  editService?: Resolver<
    ResolversTypes["Product"],
    ParentType,
    ContextType,
    RequireFields<MutationEditServiceArgs, "id" | "input">
  >;
  editUser?: Resolver<
  ...
  >;
  endSubscribe?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationEndSubscribeArgs, "id">
  >;
  hideChat?: Resolver<
    ResolversTypes["Chat"],
    ParentType,
    ContextType,
    RequireFields<MutationHideChatArgs, "id" | "isHide">
  >;
  leaveChat?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationLeaveChatArgs, "chat">
  >;
  openCase?: Resolver<
    ResolversTypes["CaseItem"],
    ParentType,
    ContextType,
    RequireFields<MutationOpenCaseArgs, "caseType" | "server">
  >;
  ...
  readNotification?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationReadNotificationArgs, "id" | "type">
  >;
  removeChat?: Resolver<
    ResolversTypes["Chat"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveChatArgs, "id">
  >;
  removeFriend?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveFriendArgs, "id">
  >;
  removeFromBlacklist?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveFromBlacklistArgs, "id">
  >;
  removeGlobalChatMessage?: Resolver<
    ResolversTypes["GlobalChatRemove"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveGlobalChatMessageArgs, "input">
  >;
  removeMessage?: Resolver<
    ResolversTypes["Message"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveMessageArgs, "id">
  >;
  removeProduct?: Resolver<
    ResolversTypes["Product"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveProductArgs, "id">
  >;
  removeReport?: Resolver<
    ResolversTypes["ReportChat"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveReportArgs, "id">
  >;
  removeService?: Resolver<
    ResolversTypes["Product"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveServiceArgs, "id">
  >;
  selectProfile?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationSelectProfileArgs, "server">
  >;
  ...
  >;
  sendReportMessage?: Resolver<
    ResolversTypes["ReportMessage"],
    ParentType,
    ContextType,
    RequireFields<MutationSendReportMessageArgs, "id" | "input">
  >;
  setRating?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationSetRatingArgs, "id" | "input">
  >;
  startSubscribe?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationStartSubscribeArgs, "id">
  >;
  updateLastOnline?: Resolver<
    ResolversTypes["Profile"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateLastOnlineArgs, "id">
  >;
};
...
export type NewsResultResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["NewsResult"] = ResolversParentTypes["NewsResult"]
> = {
  hasMore?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
...
export type NewsTagResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["NewsTag"] = ResolversParentTypes["NewsTag"]
> = {
  color?: Resolver<ResolversTypes["HEXColor"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ObjectID"], ParentType, ContextType>;
...
> = {
  __resolveType: TypeResolveFn<
    "SubscriberNotification" | "SystemNotification",
    ParentType,
    ContextType
  >;
};
...
export type ProfileStatusResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ProfileStatus"] = ResolversParentTypes["ProfileStatus"]
> = {
...
> = {
  ...
  chats?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryChatsArgs, "server">
  >;
  getChatProfiles?: Resolver<
    Array<ResolversTypes["Profile"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetChatProfilesArgs, "chat">
  >;
  getLastMessage?: Resolver<
    ResolversTypes["Message"],
    ParentType,
    ContextType,
    RequireFields<QueryGetLastMessageArgs, "chat">
  >;
  getMyStatus?: Resolver<
    ResolversTypes["ProfileStatus"],
    ParentType,
    ContextType,
    RequireFields<QueryGetMyStatusArgs, "id">
  >;
  getTref?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  globalChatMessages?: Resolver<
    Array<ResolversTypes["GlobalChatMessage"]>,
    ParentType,
    ContextType
  >;
  hidedChats?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryHidedChatsArgs, "server">
  >;
  icon?: Resolver<
    Maybe<ResolversTypes["Icon"]>,
    ParentType,
    ContextType,
    RequireFields<QueryIconArgs, "id">
  >;
  icons?: Resolver<
    ResolversTypes["IconSearchResult"],
    ParentType,
    ContextType,
    RequireFields<QueryIconsArgs, never>
  >;
  messages?: Resolver<
    ResolversTypes["MessageSearchResult"],
    ParentType,
    ContextType,
    RequireFields<QueryMessagesArgs, "chat">
  >;
  myReports?: Resolver<
    Array<ResolversTypes["ReportChat"]>,
    ParentType,
    ContextType,
    RequireFields<QueryMyReportsArgs, "profile">
  >;
  news?: Resolver<
    ResolversTypes["NewsResult"],
    ParentType,
    ContextType,
    RequireFields<QueryNewsArgs, never>
  >;
  newsByID?: Resolver<
    ResolversTypes["News"],
    ParentType,
    ContextType,
    RequireFields<QueryNewsByIdArgs, "id">
  >;
  notifications?: Resolver<
    Array<ResolversTypes["Notification"]>,
    ParentType,
    ContextType,
    RequireFields<QueryNotificationsArgs, "server">
  >;
  product?: Resolver<
  ...
  >;
  products?: Resolver<
    ResolversTypes["ProductSearchResult"],
    ParentType,
    ContextType,
    RequireFields<QueryProductsArgs, "server">
  >;
  profile?: Resolver<
  ...
  >;
  profiles?: Resolver<
    ResolversTypes["ProfileSearchResult"],
    ParentType,
    ContextType,
    RequireFields<QueryProfilesArgs, "server">
  >;
  report?: Resolver<
    ResolversTypes["ReportChat"],
    ParentType,
  ...
  >;
  reportMessages?: Resolver<
    Array<ResolversTypes["ReportMessage"]>,
    ParentType,
    ContextType,
    RequireFields<QueryReportMessagesArgs, "id">
  >;
  reports?: Resolver<
    Array<ResolversTypes["ReportChat"]>,
    ParentType,
  ...
  server?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryServerArgs, "id">
  >;
  ...
  services?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryServicesArgs, "server">
  >;
  status?: Resolver<
    ResolversTypes["UserStatus"],
    ParentType,
    ContextType,
    RequireFields<QueryStatusArgs, "server">
  >;
  user?: Resolver<
    Maybe<ResolversTypes["User"]>,
    ParentType,
  ...
  >;
  users?: Resolver<
    ResolversTypes["UserSearchResult"],
    ParentType,
    ContextType,
...
export type ReportChatResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ReportChat"] = ResolversParentTypes["ReportChat"]
> = {
  createdAt?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ObjectID"], ParentType, ContextType>;
  owner?: Resolver<ResolversTypes["Profile"], ParentType, ContextType>;
...
export type ReportMessageResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ReportMessage"] = ResolversParentTypes["ReportMessage"]
> = {
  createdAt?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ObjectID"], ParentType, ContextType>;
  message?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type SubscriberNotificationResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["SubscriberNotification"] = ResolversParentTypes["SubscriberNotification"]
> = {
  createdAt?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ObjectID"], ParentType, ContextType>;
  subscriber?: Resolver<ResolversTypes["Profile"], ParentType, ContextType>;
  to?: Resolver<ResolversTypes["ObjectID"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
> = {
  deletedMessage?: SubscriptionResolver<
    ResolversTypes["Message"],
    "deletedMessage",
    ParentType,
    ContextType,
    RequireFields<SubscriptionDeletedMessageArgs, "profile">
  >;
  editedMessage?: SubscriptionResolver<
    ResolversTypes["Message"],
    "editedMessage",
    ParentType,
    ContextType,
    RequireFields<SubscriptionEditedMessageArgs, "profile">
  >;
  globalChatMessageCreated?: SubscriptionResolver<
    ResolversTypes["GlobalChatMessage"],
    "globalChatMessageCreated",
    ParentType,
    ContextType
  >;
  globalChatMessageRemoved?: SubscriptionResolver<
    ResolversTypes["GlobalChatRemove"],
  ...
  newChat?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionNewChatArgs, "profile">
  >;
  newMessage?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionNewMessageArgs, "profile">
  >;
  newNotification?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionNewNotificationArgs, "profile">
  >;
  newReportMessage?: SubscriptionResolver<
    ResolversTypes["ReportMessage"],
    "newReportMessage",
    ParentType,
    ContextType,
    RequireFields<SubscriptionNewReportMessageArgs, "id">
  >;
};
...
> = {
  ...
  permissions?: Resolver<
    Array<ResolversTypes["Permissions"]>,
    ParentType,
    ContextType
  >;
  updatedAt?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
